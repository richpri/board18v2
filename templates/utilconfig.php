<?php
/*
 * This config.php file is included in those php utility programs
 * that access the board18 database.  Modify DB_HOST and if necessary
 * DB_DATABASE to contain the correct host and database name. You shuld
 * also change the database user ID and password here. Make them match
 * the values that have total access to the board18 database. 
 * 
