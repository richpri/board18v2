...
def add_tile_P_to_sheet(img, layer, tileName, columnNumb, rowCount):
    ''' Create a column of tiles on a type P tile sheet.
...
register(
    "add_tile_P_to_sheet",
    "Create a column of type P tiles on a tile sheet",
    "Create a column of type P tiles on a tile sheet",
    "Rich Price",
    "Rich Price",
    "2014",
    "<Image>/Filters/BD18/Add-Tile-P-to-Sheet",
    "*",
    [
